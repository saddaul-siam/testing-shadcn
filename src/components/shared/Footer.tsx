const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-slate-200/80 pb-10 pt-20 dark:bg-slate-900 lg:pb-20 lg:pt-[120px]">
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="text-body-color dark:text-dark-6 text-base">
                  &copy; {new Date().getFullYear()} Saddaul Siam
                </p>
              </div>
            </div>
          </div>
...
const LinkGroup = ({ children, header }: ILinkGroup) => {
  return (
    <>
...
const NavLink = ({ link, label }: INavLink) => {
  return (
    <li>
      <a
        href={link}
